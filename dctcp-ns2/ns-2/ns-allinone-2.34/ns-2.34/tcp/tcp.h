...
protected:
	...
	int timely_;		// whether to use timely congestion control
	int timely_packetSize_;	// Needed to convert cwnd to/from bytes from/to packets (in bytes)
	double timely_ewma_alpha_;	// Moving Average constant for RTTDiff
	double timely_t_low_;	// T_low for RTT gradient based rate update (in seconds)
	double timely_t_high_;	// T_high for RTT gradient based rate update (in seconds)
	...
	int hope_bits_;		// Number of bits to keep hope data
