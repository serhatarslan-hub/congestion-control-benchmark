...
def main():
	...
	parser.add_argument('--dctcp', action='store_true', help="Simulates DCTCP in the topology-3 congestion scenario")
	parser.add_argument('--timely', action='store_true', help="Simulates Timely in the topology-3 congestion scenario")
	parser.add_argument('--hope_sum', action='store_true', help="Simulates Hope-Sum in the topology-3 congestion scenario")
	parser.add_argument('--hope_max', action='store_true', help="Simulates Hope-Max in the topology-3 congestion scenario")
	parser.add_argument('--hope_maxq', action='store_true', help="Simulates Hope-Maxq in the topology-3 congestion scenario")
	parser.add_argument('--hope_maxqd', action='store_true', help="Simulates Hope-Maxqd in the topology-3 congestion scenario")
	parser.add_argument('--hope_maxe', action='store_true', help="Simulates Hope-Maxe in the topology-3 congestion scenario")
	parser.add_argument('--hope_maxed', action='store_true', help="Simulates Hope-Maxed in the topology-3 congestion scenario")
	parser.add_argument('--hope_sumq', action='store_true', help="Simulates Hope-Sumq in the topology-3 congestion scenario")
	parser.add_argument('--hope_sumqd', action='store_true', help="Simulates Hope-Sumqd in the topology-3 congestion scenario")
	parser.add_argument('--hope_sume', action='store_true', help="Simulates Hope-Sume in the topology-3 congestion scenario")
	parser.add_argument('--hope_sumed', action='store_true', help="Simulates Hope-Sumed in the topology-3 congestion scenario")
	parser.add_argument('--hope_squ', action='store_true', help="Simulates Hope-Squ in the topology-3 congestion scenario")
	parser.add_argument('--hope_squq', action='store_true', help="Simulates Hope-Squq in the topology-3 congestion scenario")
	...
	if (args.dctcp):
		...
		os.system('ns {0} {1} {2} {3} {4}'.format(setup_dir, congestion_alg, out_dir, num_clients, num_leafs))
